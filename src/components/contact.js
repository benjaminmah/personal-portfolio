        ...
        <div className="contact">
            ...
            <div className="contact-links">
                <a href="https://www.linkedin.com/in/benjaminmahh/" target="_blank" rel="noopener noreferrer">
                    <img src={`${baseUrl}/icons/linkedin1.png`} alt="LinkedIn" className="linkedin-icon" />
                </a>
                <a href="https://github.com/benjaminmah" target="_blank" rel="noopener noreferrer">
                    <img src={`${baseUrl}/icons/github1.png`} alt="GitHub" className="github-icon" />
                </a>
                <a href="mailto:benjaminmah.bm@gmail.com">
                    <img src={`${baseUrl}/icons/email1.png`} alt="Email" className="email-icon" />
                </a>
            ...
            <p>(p.s. my email address is benjaminmah.bm@gmail.com)</p>
        </div>
    );
}
